# 6. Evolution, Knowledge, Migration, and Open Participation — v0.3.7 candidate.0
...
Candidate.0 adds concrete substrate/protocol patterns at:
...
Candidate.0 retains `adaptation-packet.v2` as the portable represented source-context carrier and provides `tools/ena_evolve_v2.py` for narrow packet-v2 export/import. Packet transfer still does not authenticate the source or create receiver-local selection.
...
For safeguards/controls whose original failure may have disappeared or been replaced, candidate.0 provides `operational/procedures/CONTROL-RETIREMENT.md`. Retirement preserves lineage; deactivation is not historical erasure.
