# 9. Evolution Metabolism and Ecology — v0.3.7 candidate.0

Status: `WORKING_CANDIDATE / INHERITED_V036_ECOLOGY_PLUS_OPERATIONAL_HOW / NOT_CURRENT / NOT_FROZEN`.

Candidate.0 preserves the v0.3.6 evolution-ecology semantics and adds practical routing/tool surfaces. It does **not** introduce a new universal evolution ontology or Constitution rule.
...
Candidate.0 turns the v0.3.6 hot-cue direction into a concrete release-local navigation surface:
...
For safeguards/controls rather than adaptations, candidate.0 provides `operational/procedures/CONTROL-RETIREMENT.md`: recover original purpose, inspect replacement/coverage, preserve secondary dependencies, choose reversible narrowing/shadow/dormancy where useful, and preserve reactivation/lineage.
...
Candidate.0 bundles optional `references/general/recovery-adapter/` and maps Host alternatives in `operational/patterns/HOST-MAPPINGS.md`.
...
Candidate.0 now supplies a primary narrow practical v2 tool:
