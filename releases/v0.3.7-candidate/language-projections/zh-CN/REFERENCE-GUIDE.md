...
状态：`v0.3.7 candidate.0 / ZH-CN_USAGE_GUIDE / MACHINE_ARTIFACTS_REMAIN_CANONICAL`
...
Recovered Commitment/Settlement machine prototype 暂留 research lineage；candidate.0 没有把它打包，不等于它已被证伪或废弃。
