# Operational Cue Index — v0.3.7 candidate.0（简体中文投影）
...
| “执行者换了/挂了/分叉了，到底谁还欠这个 obligation？” | `OA-COM-01 Commitment/Settlement` | `HOW-MAP` 的 shared distinction；candidate.0 先组合 Effect + Authority + explicit settlement guidance |
