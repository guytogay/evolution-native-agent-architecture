# LITE Adoption Instruction — ENA v0.3.7 candidate.0
...
The active Current remains v0.3.6. This file defines the intended candidate LITE behavior for review; it does not promote candidate.0.
