...
Recommended contribution classes:
...
- publication authority/externality boundary;
- evidence/provenance;
- uncertainty and alternative explanations.

A contribution may be valuable even if it is not yet an adaptation. A stored unresolved possibility is legitimate when honestly labeled.
...
A field finding that exposes a material defect in Current may justify the smallest appropriate successor; it does not silently rewrite the release in which the defect was observed.
