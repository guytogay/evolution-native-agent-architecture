...
| “执行者换了/挂了/分叉了，到底谁还欠这个 obligation？” | `OA-COM-01 Commitment/Settlement` | `HOW-MAP` 的 shared distinction；先组合 Effect + Authority + explicit settlement guidance |
