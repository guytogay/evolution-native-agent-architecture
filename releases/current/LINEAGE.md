...
Candidate.3 is a material successor to frozen candidate.2. It was born directly from the exact frozen candidate.2 source; it does not rewrite candidate.2 occurrence truth.

```text
candidate.2 frozen source = bda470e0a6b170cec61225a905957a501454a2fe
candidate.2 frozen subtree = d5fefc8c786d7e40b3e9a59211ee7045bccee5bf
...
successor                   = v0.3.7-candidate.3
```

Candidate.3 Round-1 repair gate `33149597432` closed the sealed composed-Authority, Effect terminal-regression, transferred-source integration chronology/snapshot, and regression-provenance defects while preserving inherited valid composed-validator behavior. Round-2 reconciles active package identity/lineage/zh-CN status only.

## Preserved predecessor candidate.2 lineage

Candidate.2 passed exact pre-freeze validation, was externally frozen at source `bda470e0a6b170cec61225a905957a501454a2fe` / subtree `d5fefc8c786d7e40b3e9a59211ee7045bccee5bf`, then fresh A-S/A-P plus Phase B required candidate.3. Candidate.2 remains immutable `FROZEN / NOT_CURRENT / NOT_RELEASED` occurrence truth.

Candidate.2 itself succeeded frozen candidate.1 after candidate.1 fresh A-S/A-P required a material successor. Its repair lineage and machine evidence remain preserved in Git and reconciliation records rather than being rewritten into candidate.3 authorship.

## Candidate.1 succession

Candidate.1 is a material successor to the frozen candidate.0; it does not rewrite candidate.0 occurrence truth.

```text
candidate.0 frozen source = d0e793593184740d9732902e948afd48ed96ae2f
candidate.0 frozen subtree = cffbf76fe1448b020b637c78d1f7ae46e4c0115b
fresh Phase-A seal        = 5ba3d241efa460fe170253860ad67045aa1d96a5
candidate.0 verdict       = NEEDS_REVISION
successor                 = v0.3.7-candidate.1
```

Candidate.1 repairs four deterministic shared blind spots: imported source-context retention, tied-latest packet chronology, archive selection-preservation binding, and instantiated-record `created_at` validation. Open attack branches from Phase A remain open; succession does not erase them.

## Preserved predecessor candidate.0 lineage
