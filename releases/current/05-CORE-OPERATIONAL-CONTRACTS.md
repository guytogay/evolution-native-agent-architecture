...
This file is the single candidate-local operational-contract surface for ENA v0.3.7 candidate.3. It inherits the retained v0.3.4/v0.3.3 contract properties and the v0.3.5 released evolution, continuity, language, privacy, migration, emergence, and governance-closure semantics, plus the independently falsified/reconciled v0.3.6 ecology delta.
