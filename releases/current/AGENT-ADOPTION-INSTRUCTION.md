...
Treat a Host/runtime change as **material** only when it can invalidate a cached local fact or alter a decision boundary such as effective loading/persistence, authority/effects, recovery, Variation Space, model/provider/route, or language projection. Unrelated environment churn does not require another pass.
