#!/usr/bin/env python3
"""V0.3.3-candidate.1 deterministic regression suite.

Exercises the successor implementation candidate through its real shipped
validation surface (tools/validate_contracts.py — v0.3.3-candidate.1) against
...
Runs:
  ...
  3. successor closure corpus (contract-fixtures.v2.1.json): PR #38 fresh
     probes (43) + D1/D2/D3 closure controls (18).
...
HERE = Path(__file__).resolve().parent            # .../v0.3.3-candidate.1/tools
...
FIXTURES_V21 = HERE / "contract-fixtures.v2.1.json" # successor closure
...
def main() -> int:
    ...
    out = {
        "candidate": "releases/v0.3.3-candidate.1/tools/validate_contracts.py",
    ...
    (HERE / "regression-results-v033candidate1.json").write_text(
        json.dumps(out, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
    print()
    print("regression-results-v033candidate1.json written")
