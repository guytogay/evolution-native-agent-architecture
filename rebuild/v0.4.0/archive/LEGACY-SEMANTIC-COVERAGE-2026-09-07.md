# Archived v0.4 Legacy Semantic Coverage + Dogfood Ledger

Status: `ARCHIVED_REGRESSION_AID / NOT_PRODUCT_BLUEPRINT / NOT_CURRENT`

Archived on 2026-09-07 after the owner identified product/project boundary contamination. This ledger records a useful historical coverage pass, but its legacy taxonomy and placement decisions must not define the v0.4 product structure. Use it only after clean re-derivation to check for genuinely important omissions or regressions.

---

# ENA v0.4 Legacy Semantic Coverage + Dogfood Ledger

Status at original creation: `ACTIVE_REBUILD / NOT_CURRENT / NOT_PROMOTED`
...
The original pass clustered legacy material into Practical Core, Action Cards, machine/external layers, cold HOW, theory, and retired product units. That classification is retained here only as occurrence truth. It does not control the clean re-derivation.

## Dogfood occurrence

The original pass dogfooded the draft on ENA rebuild work and on a Human-AI Workbench runner decision. Those observations remain historical evidence. They do not establish that the legacy-derived taxonomy is the right v0.4 product shape.
