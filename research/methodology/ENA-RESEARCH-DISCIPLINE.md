...
WORKING_CATEGORIES != NATURAL_ONTOLOGY
...
-> WHAT / WHY / HOW / EVIDENCE reconstruction
...
```text
KNOWN_RESULT_SPACE != POSSIBLE_RESULT_SPACE
```
...
no represented mismatch != direct applicability established
